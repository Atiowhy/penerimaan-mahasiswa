...
$selectUser = mysqli_query($connection, "SELECT * FROM users WHERE id = '$id'");
    ...
    <ul class="menu-inner py-1">
        ...
        <?php if ($id_level == 1) : ?>
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">PIC</span>
            </li>
            <!-- User interface -->
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="pesertaPic.php" class="menu-link">
                            <div data-i18n="Accordion">Peserta Pelatihan</div>
                        </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="gelombang.php" class="menu-link">
                            <div data-i18n="Accordion">Gelombang</div>
                        </a>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="pic.php" class="menu-link">
                            <div data-i18n="Alerts">Data PIC</div>
                        </a>
                    </li>
                </ul>
            </li>
        ...
        <?php if ($id_level == 3) : ?>
            ...
            <li class="menu-item">
                <a href="javascript:void(0)" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-box"></i>
                    <div data-i18n="User interface">Data Peserta</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="peserta.php" class="menu-link">
                            <div data-i18n="Accordion">Table Data</div>
                        </a>
                    </li>
                </ul>
            </li>
