...
if (isset($_POST['register'])) {
    ...
    $register = mysqli_query($connection, "INSERT INTO users (nama_lengkap, email, id_level, password) VALUES ('$nama_lengkap', '$email', '$id_level', '$password')");
    // print_r($register);
    // die;

    if (!$register) {
        header('location: register.php?failed-register');
    } else {
                        ...
                        <form id="formAuthentication" class="mb-3" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_level" class="form-control">
                                    ...
                                    <?php while ($resultlevel = mysqli_fetch_assoc($level)): ?>
                                        <option value="<?php echo $resultlevel['id'] ?>"><?php echo $resultlevel['nama_level'] ?></option>
                                    <?php endwhile ?>
                                </select>
                            </div>
                            <div class="mb-3">
